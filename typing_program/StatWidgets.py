...
from typing_program.WeakSpotLessons import ana_what_kind
...
class StringStats(QWidget):
  ...
  def __init__(self, *args):
    ...
    self._search_btn = AppButton('Search', self._on_search_btn)
