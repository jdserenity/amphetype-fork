...
from typing_program.Text import LessonMiner
from typing_program.Data import DB
from typing_program.QtUtil import *
from typing_program.Config import *
from typing_program.gutenberg.browser import GutenbergBrowser
...
Typing Program is a layout-agnostic typing trainer that measures your speed and progress while identifying typing problems. This is just a default text since your database is empty. Go to Preferences → Sources and try importing a text. Several whole novels already come packaged with Typing Program! Later on you can generate highly customizable lessons directly from your statistics!
Good luck!""")
    ...
    self.setLayout(AppBoxLayout(
        [
          ([
            ...
            (self.tree, 1),
            self.progress,
            [AppButton("Import Texts", self.addFiles), None,
              AppButton("Enable All", self.enableAll),
              AppButton("Delete Disabled", self.removeDisabled), None,
              AppButton("Update List", self.update)],
            [AppButton("Delete selected", self.deleteSelected), None,
              AppButton("Toggle disabled", self.disableSelected),
